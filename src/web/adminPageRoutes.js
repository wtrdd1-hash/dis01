            ...
            html += `
              <tr style="${isCurrentlyBanned ? 'background: rgba(239, 68, 68, 0.08);' : (isTaxKingUser ? 'background: rgba(245, 158, 11, 0.05);' : '')}">
                ...
                <td style="text-align:center; white-space:nowrap;">
                  ...
                  <button type="button" onclick="openSingleUserDeleteModal('${escapeJsStr(u.discord_id)}', '${escapeJsStr(u.username)}')" style="background:#b91c1c; border:1px solid #ef4444; color:#fff; padding:4px 8px; border-radius:6px; font-size:0.75rem; cursor:pointer; font-weight:800; margin-right:4px;" title="이 유저만 삭제 또는 초기화">🗑️ 삭제</button>
