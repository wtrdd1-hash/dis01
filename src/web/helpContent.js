...
const ARTICLES = [
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: '#채굴에서 보석을 누르면 현금을 법니다. 해금 비용과 난이도가 높은 장르일수록 인정된 클릭의 현금 보상이 커지며, 디스코드 /클리커에도 같은 장르 배율이 적용됩니다.' },
      { type: 'ul', items: [
        '클릭 1회 기본값: 채굴기 레벨 × 6원. 여기에 장르 배율과 장비 보너스가 적용됩니다.',
        '치명타: 8% 확률로 2배.',
        '장르 14종. 기본 보석 연타 외에 두더지·짝맞추기·광차·빙하·용암·광맥 따라가기 같은 미니게임이 있습니다.',
        '보석 연타는 기본 개방. 다른 장르는 현금으로 한 번 해금하면 계속 유지됩니다.',
        '일부 장르는 타이밍·짝·빛나는 칸이 맞을 때만 채굴로 인정됩니다. 장르 배율은 x1.00부터 x2.25까지입니다.',
        '자동봇: 레벨 × 초당 2원. 켜 두면 접속 중 계속 들어옵니다.',
        '채굴기 강화 비용: 현재 레벨 × 8,500원.',
        '자동봇 구매 비용: (자동봇 레벨 + 1) × 20,000원.'
      ] }
    ]
  },
  {
