...
// 타겟 섹터별 현실적 경제 뉴스 이벤트
const NEWS_EVENTS = [
  { 
    text: '🏦 미국 연준(Fed), 기준금리 동결 및 인하 가능성 시사! 증시 전반에 봄바람이 붑니다.', 
    impact: { ALL: 0.05, BTC: 0.08, ETH: 0.07 } 
  },
  { 
    text: '📉 unexpected CPI(소비자물가지수) 상승으로 연준의 긴축 장기화 우려에 매도세가 쏟아집니다.', 
    impact: { ALL: -0.06, BTC: -0.08 } 
  },
  { 
    text: '🚀 엔비디아, 차세대 AI 가속기 칩 획기적 성능 발표! AI 및 반도체 섹터 폭발적 상승!', 
    impact: { NVDA: 0.15, SAM: 0.08, AAPL: 0.04 } 
  },
  { 
    text: '⚡ 비트코인 현물 ETF 기관 자금 대량 유입! 가상자산 시장 전반 랠리!', 
    impact: { BTC: 0.16, ETH: 0.12 } 
  },
  { 
    text: '⚠️ 글로벌 반도체 공급망 차질 우려로 IT 및 첨단 제조주 일시 조정.', 
    impact: { SAM: -0.07, NVDA: -0.05, AAPL: -0.04 } 
  },
  { 
    text: '🎉 K-바이오 핵심 신약 3상 성공 및 글로벌 제약사 기술 수출 계약 체결!', 
    impact: { BIO: 0.18 } 
  },
  { 
    text: '⚠️ 주요 국 바이오 임상 차질 뉴스 및 약가 규제 논의로 제약 섹터 투심 악화.', 
    impact: { BIO: -0.10 } 
  },
  { 
    text: '🍏 애플, 혁신적인 차세대 온디바이스 AI 단말기 공개로 실적 기대감 폭발!', 
    impact: { AAPL: 0.10, SAM: 0.03 } 
  },
  { 
    text: '🏛️ 주요 7개국(G7) 가상자산 규제 강화 합의 소식에 암호화폐 일시 하락.', 
