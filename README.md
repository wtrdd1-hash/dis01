...
### 3. ⚡ 도박 턴(Turn) 시스템 & 중복 방지 락
* **에너지/턴 시스템:** 기본 50턴 (최대 50턴), 소진 시 **30초마다 +1턴씩 자동 회복**.
* **턴 보너스 획득처:**
  * ⛏️ **클리커 채굴:** 광석 클릭 시 12~15% 확률로 도박 턴 +1 드랍
  * 🎁 **일일 출석체크:** +15턴 즉시 충전
  * 🏛️ **기본소득 지원금:** +10턴 즉시 충전
  * 🛒 **상점 긴급 충전팩:** 20,000원으로 +25턴 즉시 충전
